        ...
        Card(
            ...
            AnimatedVisibility(
                ...
                Column(
                    ...
                    val name: String = remember(oidQuery.value) {
                    ...
                    val description: String = remember(oidQuery.value) {
                        OIDCatalog.getSysDescrByOid(oidQuery.value) ?: oidQuery.value
                    }
                    if (description != oidQuery.value) {
                        Row {
                            Text(
